...
## Open Source Work at K-Scale:
- **[K-Bot Teleoperation](https://github.com/kscalelabs/kbot_vr_teleop)**: WebXR frontend for video streaming and hand tracking. Backend code for Inverse Kinematics and WEBRTC signaling relay.
- **[K-Bot Firmware](https://github.com/kscalelabs/pyfirmware)**: K-Bot firmware written in Python. 
...
- **[eCFR Analyzer Detection](https://github.com/carlson3912/eCFR-analyzer)**: Uses the eCFR (Electronic Code of Federal Regulations) API to do some analysis on the current state and historical trends of the database. This was a 24 hour project for an interview. It is live **[here](https://peppy-cannoli-580ad8.netlify.app/)**.
